...
$result = mysqli_query($conn, $sql);
  ...
  $sum = ($salary['base']*$salary['bonus'])+$salary['base'];
  ...
  <header>
    <nav>
      ...
      <ul id="navli">
        ...
        <li><a class="homeblue" href="myprofile.php?id=<?php echo $id?>"">My Profile</a></li>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="input-group">
                          <p>Total Salary</p>
                            <input class="input--style-1" type="text" name="degree" value="<?php echo $sum;?>" readonly>
                        </div>
