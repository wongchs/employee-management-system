...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				<li><a class="homeblue" href="eloginwel.php?id=<?php echo $id?>"">HOME</a></li>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Fellow Employees </h2>
    	<table>
