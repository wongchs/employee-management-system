    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homeblue" href="addemp.php">Add Employee</a></li>
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                         ...
                         <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Position" name="WorkID" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Department" name="dID" required="required">
                        </div>
